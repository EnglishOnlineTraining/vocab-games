...
**Not migrated (different architecture, unchanged):** the `it-*` series (10 pages — bespoke ES6 framework, no name entry/submission), and the non-step pages (`vocab-games.html`/`index.html`, `9g-class-test-9ab.html`, `uni-pm-vocabulary.html`, `uni-writing-task.html`, `uni-presentation-task.html`, `year-7-class-wall.html`, hub pages).
