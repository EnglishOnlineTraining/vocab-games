...
the five course hubs, and a "Browse everything" block linking the full filter index, the grammar
topics and the quizzes. A category only renders as "Coming Soon" when its real count is 0. **Never
